this.fpv_throw_acid_flask_skill <- this.inherit("scripts/skills/actives/fpv_base_skill", {
	m = {},
	function create()
	{
		this.fpv_base_skill.create();
		this.m.ID = "actives.fpv_throw_acid_flask";
		...
		this.m.Icon = "skills/fpv_active_106.png";
	...
	function isHidden() {
		...
		if (offhand == null)
			return true;
		return offhand.getID() != "weapon.acid_flask";
	}
});
